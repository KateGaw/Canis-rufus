...
function calc_click() {
  ...
  final.innerHTML = 'Пустыня - это Ваша жизнь. И то, насколько Вам в ней комфортно показывает, '
  ...
  + ans[4] + '. <br><br>  Лестница - это символ отношений с окружающими людьми - друзьями, родственниками. Ваша лестница '
  + ans[5] + ' Ваша лестница ' + ans[6] + ' Она ' + ans[7]
  + '<br><br>  Цветы обозначают роль детей в жизни человека. Вы '
  + ans[8] + ' Цветы ' + ans[9] + ' Вам ' + ans[10]
  + '<br><br>  Лошадь символизирует Вашу вторую половинку. '
  + ans[11] + ' В пустыне Ваша лошадь находится ' + ans[12] + ans[13] + ' Вы нуждаетесь '
  + ans[14] + '<br><br>  Буря символизирует отношение человека к жизненным проблемам. Судя по всему, '
  + ans[15] + ans[16];
